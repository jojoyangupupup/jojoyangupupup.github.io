    ...
    documents: [
      ...
      },
      {
        ...
        memory: {
          ...
          kpis: [
            { value: "+51.6%", label: "创建笔记本 UV，6 月周均到 7 月周均" },
            { value: "+35.6%", label: "使用 UV，6 月周均到 7 月周均" },
            { value: "+25.8%", label: "提问 UV，6 月周均到 7 月周均" },
            { value: "77.1%", label: "创建用户进一步进入实际使用" },
          ],
          monthly: [
            { label: "创建笔记本 UV", old: "501", new: "760", oldPercent: 66, newPercent: 100, delta: "+51.6%" },
            { label: "使用 UV", old: "427", new: "579", oldPercent: 74, newPercent: 100, delta: "+35.6%" },
            { label: "提问 UV", old: "218", new: "274", oldPercent: 80, newPercent: 100, delta: "+25.8%" },
            { label: "发起任务 UV", old: "408", new: "545", oldPercent: 75, newPercent: 100, delta: "+33.6%" },
          ],
