...
export const ROOMS = [
  ...
  },
  {
    ...
    title: "Doorstep",
    path: "/rooms/doorstep",
    image: "/assets/rooms/doorstep-house-final.png?v=2",
    ...
    objectHotspots: [
      {
        ...
        label: "微信号",
        ariaLabel: "复制微信号",
        path: "M 780 170 C 775 169 767 172 761 178 C 757 182 756 187 756 194 L 756 270 C 756 278 760 284 767 289 L 838 332 C 847 337 856 338 862 331 C 865 328 866 323 866 317 L 866 215 C 866 208 863 204 857 201 L 786 170 C 784 169 782 169 780 170 Z",
        glowPath: "M 780 170 C 775 169 767 172 761 178 C 757 182 756 187 756 194 L 756 270 C 756 278 760 284 767 289 L 838 332 C 847 337 856 338 862 331 C 865 328 866 323 866 317 L 866 215 C 866 208 863 204 857 201 L 786 170 C 784 169 782 169 780 170 Z",
        action: {
          type: "copy",
