...
export const ROOMS = [
  ...
  },
  {
    ...
    title: "Doorstep",
    path: "/rooms/doorstep",
    image: "/assets/rooms/doorstep-house-transparent.png",
    alt: "暖色等距视角门廊小屋，包含开放木门、鞋柜、帆布袋和信箱",
    ...
    objectHotspots: [
      {
        ...
        glowPath: "M 932 243 C 923 245 917 256 916 271 L 906 307 C 900 318 896 331 895 345 L 902 371 L 899 412 C 907 427 922 434 938 439 C 944 440 950 438 953 435 L 967 408 L 975 339 L 972 316 L 958 291 C 954 273 950 257 943 248 C 940 244 936 242 932 243 Z",
      },
    ],
    hotspotPath: "M 0 0 Z",
