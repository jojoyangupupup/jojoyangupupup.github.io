    ...
    documents: [
      ...
      },
      {
        ...
        memory: {
          ...
          contentArchive: [
            { number: "01", title: "PPT 生成功能上新", type: "功能上新 / 场景教育", description: "从临时汇报、材料堆积和时间不足的工作困境切入，讲清楚用户如何把已有资料交给 AI，快速获得一份可以继续修改的汇报初稿。" },
            { number: "02", title: "信息图场景教育", type: "场景教育 / 使用引导", description: "用“一整份长文档”和“一张信息图”的差异，说明 AI 如何帮助用户提炼重点、压缩信息，让复杂内容更容易被阅读和传播。" },
            { number: "03", title: "周报生成使用内容", type: "使用教程 / 场景内容", description: "围绕“每周都要重新回忆和整理工作”的痛点展开，说明 AI 可以从已有材料中找到工作进展，帮助用户更快组织成周报，而不是凭空生成内容。" },
            { number: "04", title: "知识库问答内容", type: "功能介绍 / 深度使用", description: "从“资料已经沉淀，但真正需要时找不到”切入，展示用户如何通过连续提问定位信息、提炼结论，再把知识库内容转化为可继续使用的工作成果。" },
          ],
          paragraphs: [
