...
function renderBilibiliExperience() {
  ...
  return `<article class="bilibili-experience" aria-labelledby="bilibili-title">
    <header class="bili-profile-card"><p class="bili-kicker">B 站 UP 主 · 自述档案 · v1 预览</p><div class="bili-title-row"><div><h2 id="bilibili-title">一个把 YouTube 当选题库的人</h2><p class="bili-role">B站 UP 主 / 半自动化单人运营</p></div><a class="bili-uid" href="https://space.bilibili.com/702930217/favlist?fid=1094725617&ftype=create" target="_blank" rel="noreferrer">UID <strong>702930217</strong> ↗</a></div><p class="bili-intro">我是一个长期实践<strong>YouTube 视频搬运到 B 站</strong>的 UP 主：选题从 YouTube 来，加工在剪映里完成，<strong>内容覆盖学习、烹饪、生活、装修设计四个方向</strong>。目前 3,415 粉，主要靠<strong>主页小铺和平台流量分成</strong>过活。</p><div class="bili-meta"><span>数据观测日<strong>2026-08-10 · B站 API 实测</strong></span><span>所属分区<strong>知识 · 生活 · 美食 · 家居</strong></span><span>运营模式<strong>半自动化 · 单人独立运营</strong></span></div></header>
    <section class="bili-section"><div class="bili-section-heading"><span>01</span><h3>核心数据</h3><em>ACCOUNT SNAPSHOT</em></div><div class="bili-stat-grid"><div><small>FOLLOWERS</small><strong>3,415</strong><p>半自动化 · 单人独立运营</p></div><div><small>单期制作耗时</small><strong>30 min</strong><p>YouTube 链接 → 剪映素材包</p></div><div><small>单期发布耗时</small><strong>60 min</strong><p>剪辑 + 封面 + 简介 + 发布</p></div><div><small>流程跑通</small><strong>约 2 个月</strong><p>节省 6h → 1.5h · 搬运 50+ 期 · 翻译评论 200+ 条</p></div></div></section>
    <section class="bili-section"><div class="bili-section-heading"><span>02</span><h3>我的内容方向</h3><em>CONTENT MIX</em></div><p class="bili-subtitle">不是什么都做，是“杂食策略”——用宽内容面覆盖更多兴趣人群，再通过系列化让他们沉淀。</p><div class="bili-direction-grid">${directions.map(item => { const [label, stars] = item.split("|"); return `<div><strong>${label}</strong><span>翻译难度 <b>${stars}</b></span></div>`; }).join("")}</div><p class="bili-note">不再设四个固定栏目，改为按博主做系列——同一个 YouTube 博主连续搬运 8-12 期，让观众因为系列留下，不是靠栏目名留下。</p><div class="bili-highlight-grid"><div><b>半自动化</b><p>6 阶段流水线把“体力活”压到 30 分钟，剩下时间留给加工。</p></div><div><b>从“找选题”到“挑选题”</b><p>博主图鉴让选品不再从 0 开始，而是在已知候选池里做判断。</p></div></div><div class="bili-blogger-entry"><div><small>REAL-TIME SOURCE LIBRARY</small><h4>三、博主图鉴（实时选品系统）</h4><p>这是账号的“原料仓”：每一个考虑搬运的 YouTube 博主都有一张卡片收进图鉴。</p><div><span>图鉴覆盖博主数 20 个</span><span>每周扫描约 1.5 小时</span><span>命中率约 1%</span></div></div><a href="#blogger-book" class="bili-entry-button">查看博主图鉴 →</a></div></section>
    ...
    <section class="bili-section"><div class="bili-section-heading"><span>05</span><h3>我自研的工具：一条命令完成搬运</h3><em>TECH STACK</em></div><p class="bili-copy">最开始每期花 6 小时手动跑下载、抽音频、转字幕、抽帧、翻译和整理素材包。做了 5 期后，我写了一条 Python 脚本《一条命令搬运.py》，把前 5 步串成流水线。现在一期视频从 YouTube 链接到剪映素材包，人工只需要 30 分钟。</p><div class="bili-tool-flow"><span>STAGE 02 抽音频 <small>ffmpeg</small></span><i>→</i><span>STAGE 03 Whisper 转字幕 <small>whisper-local</small></span><i>→</i><span>STAGE 04 抽关键帧 <small>ffmpeg · 1/4 1/2 3/4</small></span></div><p class="bili-footnote">整套工具已通过冒烟测试，覆盖视频不可用、API 失败、依赖缺失、网络中断四种场景，一个人也能稳定周更 2-3 期。</p></section>
