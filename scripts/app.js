...
function renderBilibiliExperience() {
  ...
  return `<article class="bilibili-experience" aria-labelledby="bilibili-title">
    <header class="bili-profile-card"><p class="bili-kicker">B 站 UP 主 · 自述档案 · v1 预览</p><div class="bili-title-row"><div><h2 id="bilibili-title">一个把 YouTube 当选题库的人</h2><p class="bili-role">B站 UP 主 / 半自动化单人运营</p></div><a class="bili-uid" href="https://space.bilibili.com/702930217" target="_blank" rel="noreferrer">UID <strong>702930217</strong> ↗</a></div><p class="bili-intro">我是一个长期实践<strong>YouTube 视频搬运到 B 站</strong>的 UP 主：选题从 YouTube 来，加工在剪映里完成，<strong>内容覆盖学习、烹饪、生活、装修设计四个方向</strong>。目前 3,415 粉，主要靠<strong>主页小铺和平台流量分成</strong>过活。</p><div class="bili-meta"><span>数据观测日<strong>2026-08-10 · B站 API 实测</strong></span><span>所属分区<strong>知识 · 生活 · 美食 · 家居</strong></span><span>运营模式<strong>半自动化 · 单人独立运营</strong></span></div></header>
